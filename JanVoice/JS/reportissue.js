...
function validateComplaint() {
    ...
    const title =
        document.getElementById(window.reportIssueIds.title);

    const category =
        document.getElementById(window.reportIssueIds.category);

    const description =
        document.getElementById(window.reportIssueIds.description);
